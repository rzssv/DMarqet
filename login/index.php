  ...
  <body>
    <div class="container">
      <div class="login-form">
        <h1 style="font-size: 35px;margin:0;">Login</h1>
        ...
        <form action="/loggedin" method="post">
          ...
          <br>
          <button class="form-submit" style="font-family: Roboto;margin: 5px;margin-bottom: 0;" type="submit">Login</button>
        </form>
        <hr style="width: 20vw;border: 1px solid black;">
        <span style="font-size: 15px;"><a style="margin-inline: 10px;" href="/signup">Sign Up</a><a style="margin-inline: 10px;" href="/">Home</a></span>
      </div>
    </div>
  </body>
</html>